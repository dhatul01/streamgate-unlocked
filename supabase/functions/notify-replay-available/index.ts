...
serve(async (req) => {
  ...
  try {
    ...
    // Collect phone numbers from coin_orders (confirmed buyers of this show)
    // Coin orders don't have show_id directly, but coin_transactions reference_id = show_id for redeems
    ...
    // Get phone numbers from coin_orders for these users
    ...
    // Also get subscription_orders for this show
