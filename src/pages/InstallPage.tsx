    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="mx-auto max-w-md px-4 py-10">
        ...
        <div className="flex flex-col items-center text-center mb-8">
          <img src={logo} alt="RealTime48" className="h-20 w-20 rounded-2xl border border-primary/30 shadow-[0_0_20px_hsl(var(--primary)/0.3)] mb-4" />
          <h1 className="text-2xl font-bold text-foreground">Install RealTime48</h1>
          <p className="mt-2 text-sm text-muted-foreground">
            Dapatkan pengalaman terbaik dengan menginstall aplikasi ke HP kamu
          </p>
        </div>
        ...
        {installed ? (
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-xl bg-primary px-6 py-4 text-base font-bold text-primary-foreground shadow-lg shadow-primary/25 transition hover:bg-primary/90 active:scale-[0.98]"
          >
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-1.5 text-sm text-muted-foreground">
                  Ketuk tombol <Share className="inline h-4 w-4 text-primary" /> <span className="font-medium text-foreground">Share</span> di Safari
                </div>
              </div>
              <div className="flex items-center gap-3">
          ...
          <div className="rounded-xl border border-border bg-card p-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-primary/10 text-sm font-bold text-primary">1</div>
                <div className="flex items-center gap-1.5 text-sm text-muted-foreground">
                  Ketuk <MoreVertical className="inline h-4 w-4 text-primary" /> <span className="font-medium text-foreground">menu browser</span>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-primary/10 text-sm font-bold text-primary">2</div>
