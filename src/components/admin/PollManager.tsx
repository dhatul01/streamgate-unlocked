...
const PollManager = () => {
  ...
  const handleCreate = async () => {
    ...
    setCreating(true);
    await supabase.from("live_polls").update({ is_active: false, ended_at: new Date().toISOString() }).eq("is_active", true);
  ...
  const handleEnd = async (id: string) => {
    await supabase.from("live_polls").update({ is_active: false, ended_at: new Date().toISOString() }).eq("id", id);
