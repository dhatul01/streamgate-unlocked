    ...
    >
      ...
      <div className="rounded-lg bg-primary/5 border border-primary/20 p-3 mb-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <button onClick={handleCopy} className="rounded-lg bg-secondary p-2 hover:bg-secondary/80">
            <Copy className="h-3.5 w-3.5 text-foreground" />
          </button>
          <button onClick={handleShare} className="rounded-lg bg-primary p-2 hover:bg-primary/90">
